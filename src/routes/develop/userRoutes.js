...
router.get('/page', authMiddleware.isAuthenticated, role.checkRole(['develop']),  user.page);
router.get('/data', authMiddleware.isAuthenticated, role.checkRole(['develop']), user.getAll);
router.get('/detail/:id', authMiddleware.isAuthenticated, role.checkRole(['develop']), user.getById);
